/**
 * DM9051 — SPI Ethernet module example
 *
 * Connects using a DAVICOM DM9051 SPI module with WiFi as fallback.
...
void setup()
{
    ...
    config.ethernet.spiModule = EthWiFiManager::SpiModule::DM9051;
