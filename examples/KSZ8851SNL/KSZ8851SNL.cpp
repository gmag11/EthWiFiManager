/**
 * KSZ8851SNL — SPI Ethernet module example
 *
 * Connects using a Microchip KSZ8851SNL SPI module with WiFi as fallback.
...
void setup()
{
    ...
    config.ethernet.spiModule = EthWiFiManager::SpiModule::KSZ8851SNL;
